...
describe('now-playing history', () => {
  ...
  /**
   * The persistence half of the acceptance: unlike the roster, this is written
   * down, so it outlives the socket that watched it happen. A reload starts a
   * new socket and gets the whole evening back.
   */
